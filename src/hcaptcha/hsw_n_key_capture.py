...
from .tools.wasm_disasm import WasmModule, decode_uleb, decode_sleb
from .tools.wasm_writer import ModuleWriter, encode_uleb, encode_sleb



# WebAssembly.instantiate hook — substitutes our patched WASM blob in
# place of the bundle's original. The patched blob is base64-encoded
# into globalThis.__patched_wasm_b64 by the caller before evaluating
# hsw.js.
_HOOK_JS = r"""
(function () {
  function _b64ToU8(s) {
